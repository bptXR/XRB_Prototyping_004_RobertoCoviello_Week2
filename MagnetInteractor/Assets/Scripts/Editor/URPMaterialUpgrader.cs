...
namespace BearingPoint.Utility.Helpers.Tools.Editor
{
    ...
    {
        [MenuItem("Robi/Universal Render Pipeline/Upgrade Project Materials to UniversalRP Materials")]
        ...
        [MenuItem("Robi/Universal Render Pipeline/Upgrade Selected Materials to UniversalRP Materials")]
        ...
        [MenuItem("Robi/Universal Render Pipeline/Upgrade Materials From Selected Folder to UniversalRP Materials")]
